...
namespace MoreMountains.Feedbacks
{
    ...
    {
        public delegate void Delegate(float duration, float amplitude, float frequency, bool infinite = false, int channel = 0);
        static private event Delegate OnEvent;
        ...
        static public void Trigger(float duration, float amplitude, float frequency, bool infinite = false, int channel = 0)
        {
            OnEvent?.Invoke(duration, amplitude, frequency, infinite, channel);
        }
    }
