...
namespace UnityEditor
{
    ...
    internal class RuleTileEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            tile.m_WeightedSprite = EditorGUILayout.ObjectField("Weighted Sprite", tile.m_WeightedSprite, typeof(Sprite), false) as Sprite;
            tile.m_Weight = EditorGUILayout.IntField("Weight", tile.m_Weight);
